...
Last updated: 2026-06-19 (Sprint 23 - Phase 13 T3: test coverage — escalation-service. `EscalationServiceTest` (11, Mockito): materialization repeat math + scheduling guards + cancel-on-close + fireDueTask resolution. `EscalationTaskClaimTest` (1, compose-PG): first automated proof of the Phase 11 FOR UPDATE SKIP LOCKED claim)
