...
Last updated: 2026-06-19 (Sprint 25 - Phase 13 T5 + **Phase 13 complete**: test coverage — integration-service normalize/outbox-in-tx + schedule DST edge. Repo went from ~3 tests to **62**; §16 strategy filled without Docker: Mockito + EmbeddedKafka + compose-PG)
