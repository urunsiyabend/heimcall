...
| **Event-chain throughput ~100 msg/s per service** — `OutboxRelay` poll(1000ms)×batch(100) caps publish rate; at 676 req/s accept the chain backs up (load test 2026-06-25) | Phase 18 T1 |
