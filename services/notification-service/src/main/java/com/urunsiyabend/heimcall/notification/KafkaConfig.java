 ...
 * so the partition is never blocked. Also configures the producer for outbound
 * {@code notification.delivered.v1} / {@code notification.failed.v1} events.
 */
@Configuration
public class KafkaConfig {
    ...
    // Outbound notification.delivered/failed events. JSON with type-info headers.
    @Bean
